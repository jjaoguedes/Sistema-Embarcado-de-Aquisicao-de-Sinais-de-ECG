...
async function loadPatients() {
    ...
    try {
        const response = await fetch(`http://${host}/Sistema-Embarcado-de-Aquisicao-de-Sinais-de-ECG/Model_Web_IA_Arritmias/backend/API/get_patients.php`); // Endpoint correto
        if (!response.ok) {
